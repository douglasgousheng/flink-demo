...
public class Flink01_State_Operator {
    ...
    private static class CountMapper implements MapFunction<String,Long>, CheckpointedFunction {
        ...
        //初始化时会调用这个方法，像本地状态中填充数据，每个子任务调用一次
        @Override
        ...
        //Checkpoint是会调用这个方法，我们要实现具体的snapshot逻辑，比如将哪些本地状态持久化
        @Override
